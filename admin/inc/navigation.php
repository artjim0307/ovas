<?php
// Set page variable based on user type
$page = isset($_settings) && $_settings->userdata('type') == 3 ? 'dashboard' : 'home';
...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar  elevation-4 sidebar-no-expand ">
        <!-- Brand Logo -->
        <a href="<?php echo base_url ?>admin" class="brand-link  text-sm border-info shadow-sm ">
    ...
    <li class="nav-item">
        <a href="<?php echo base_url ?>admin/?page=dashboard" class="nav-link nav-dashboard">
            <i class="nav-icon fas fa-tachometer-alt"></i>
            <p>
                Dashboard
            </p>
...
<?php endif; ?>
                    ...
                    <li class="nav-item">
                      ...
                      <li class="nav-item">
                            <?php if($_settings->userdata('type') == 3): ?>
                      <a href="<?php echo base_url ?>admin/?page=mydogs" class="nav-link nav-inquiries">
 ...
 <script>
    ...
    $(document).ready(function(){
        // Set page variable based on user type
        <?php if(isset($_settings) && $_settings->userdata('type') == 3): ?>
